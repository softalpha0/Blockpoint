...
/**
 * LOCK vault
 * - Users deposit an asset (USDC, USDT, etc)
 * - They earn BPT (BlockPoint Token) as rewards
 * - BPT represents their yield from locking funds
 */
contract LockVault is ERC20, Ownable {
    using SafeERC20 for IERC20;

    IERC20 public immutable asset;       // e.g. USDC
    IERC20 public immutable rewardToken; // BPT
    ...
    constructor(
        ...
        ERC20("BlockPoint Token", "BPT") // ✅ SHARE / REWARD TOKEN
    ...
    function deposit(uint256 amount) external {
        ...
        _mint(msg.sender, amount); // shares = deposit amount
